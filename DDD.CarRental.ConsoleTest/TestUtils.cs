...
namespace DDD.CarRental.ConsoleTest
{
    public class TestUtils
    {
        public static CarRentalDbContext InitializeCarRentalContext()
        {
            ...
            // Scaffold-DbContext "Server=(localdb)\mssqllocaldb;Database=_assecurity_S3;Trusted_Connection=True;" Microsoft.EntityFrameworkCore.SqlServer -OutputDir ScadaInfrastructure\Models
